    ...
    <main className="max-w-full px-8 sm:px-16 ml-16 mr-16">
      <div className="flex justify-between ml-4">
        <div className="my-10 w-full md:w-2/3">
          <div className="text-xl md:text-2xl font-semibold" data-testid={'property-desc'}>
            {data?.description}
          </div>
